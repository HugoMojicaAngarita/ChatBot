...
def get_answer(question_entry, response_box):
    ...
    if question:
        ...
        result = agent_answer(question=question, llm=llm, vector_store=vector_store)
        
        # Inserta la pregunta y la respuesta en el cuadro de texto
        response_box.insert(tk.END, f"You: {question}\n", "user")
        response_box.insert(tk.END, f"Assistant: {result}\n\n", "assistant")
        
        # Limpia el campo de entrada de la pregunta
